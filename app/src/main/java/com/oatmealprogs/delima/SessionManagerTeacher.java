...
public class SessionManagerTeacher {

    SharedPreferences userSession;
    SharedPreferences.Editor editor;
    Context context;

    public static final String SESSION_LOGIN = "sessionTeacher";
     ...
     */
    public SessionManagerTeacher(Context _context, String preferencesID) {
        this.context = _context;
        userSession = context.getSharedPreferences(preferencesID, Context.MODE_PRIVATE);
        editor = userSession.edit();
    }

    public void createLoginSession(String userID, String password, String firstName, String lastName) {
